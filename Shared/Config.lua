--[[
    ...
    This is the main DarkRP configuration file
...
DarkRP.Config.CHARACTER_MESHES = {
	"nanos-world::SK_Male",
...
DarkRP.Config.SK_MALE_HAIR_MESHES = {
	"",
...
DarkRP.Config.SK_MALE_BEARD_MESHES = {
	"",
...
DarkRP.Config.SK_FEMALE_HAIR_MESHES = {
	"",
	"nanos-world::SM_Hair_Kwang"
}

-- List of Death Male voices
DarkRP.Config.MALE_DEATH_SOUNDS = {
...
DarkRP.Config.MALE_PAIN_SOUNDS = {
...
DarkRP.Config.FEMALE_DEATH_SOUNDS = {
...
DarkRP.Config.FEMALE_PAIN_SOUNDS = {
...
DarkRP.Config.HUMAN_MORPH_TARGETS = {
	"nose1",
	"nose2",
	"brows",
	"mouth",
...
DarkRP.Config.HUMAN_SKIN_TONES = {
